...
(function (){
    ...
    //     oDiv = document.getElementById("maincontent");
    // oHost.className = "iName";
    // oHost.innerHTML = "<%=striptags( (boardinfo.hostname or " + "?" + ") ) %>";
    // if(oMain.parentNode.className.split(/\s+/)[1] == "node-main-login"){
    //     oDiv.parentNode.insertBefore(oHost, oDiv);
    // }
